...
Im Projekt benutzen wir jedoch nicht die Rust API direkt, sondern nutzen eine graphische Nutzeroberfläche mit welcher man Audio-Graphen dieser Art visuell erstellen kann. Abbildung \ref{fig:datagraph} zeigt die visuelle Darstellung eines Audio-Graphen in der Nutzeroberfläche.
